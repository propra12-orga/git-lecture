...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Übungsform: regelmäßige Wiederholung
      ...
      \end{itemize}
    \item Name "`Kata"' entstammt Analogie zur Kampfkunst
  \end{itemize}
\end{frame}
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Bei einem Spare (10 Pins mit zwei Würfen in einem Frame) wird der erste Wurf des nächsten Frames doppelt gezählt.
    \item Bei einem Strike (10 Pins mit einem Wurf - das beendet den Frame) wird der ganze nächste Frame doppelt gezählt.
    \item Die Regeln für den letzten Frame sind irrelevant für die Kata (Erweiterungen sind willkomen).
  \end{itemize}
\end{frame}
\begin{frame}
  \frametitle{Tests für das BowlingGame}
  \begin{itemize}
